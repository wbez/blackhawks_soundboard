...
```
cd blackhawks_soundboard
mkvirtualenv blackhawks_soundboard
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=13wB-Fl6psiNPbl_ucUXnfyThZJbe-u9V_iA3VVfbMNo#gid=0).
...
def read_my_google_doc():
    ...
    get_document('13wB-Fl6psiNPbl_ucUXnfyThZJbe-u9V_iA3VVfbMNo', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/blackhawks_soundboard/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|blackhawks_soundboard|tweet|`location`||
|blackhawks_soundboard|facebook|`location`||
|blackhawks_soundboard|email|`location`||
|blackhawks_soundboard|new-comment||
|blackhawks_soundboard|open-share-discuss||
|blackhawks_soundboard|close-share-discuss||
|blackhawks_soundboard|summary-copied||
|blackhawks_soundboard|featured-tweet-action|`action`|
|blackhawks_soundboard|featured-facebook-action|`action`|
